...
//STUDY THIS :(
		...
		switch (tileTypeUnder) {
			...
			case WORLD_GOAL:
				...
				canvasContext.fillStyle = '#28B463';
				canvasContext.font = '20px Arial';
				canvasContext.fillText("What are you doing looking for treasure?", canvas.width / 2 - 200, canvas.height/2 - 100);
				canvasContext.fillText("You're the most precious thing for miles!", canvas.width / 2 - 200, canvas.height/2 - 80);
				canvasContext.font = '50px Arial';
				canvasContext.fillStyle = 'dodgerblue';
				canvasContext.fillText("Happy Birthday, Ishy!!♥", canvas.width / 2 - 275, canvas.height/2);				
